...
GO
PRINT N'Creating Foreign Key [dbo].[FK_TailorOrders_Measurements]...';


GO
ALTER TABLE [dbo].[TailorOrders]
    ADD CONSTRAINT [FK_TailorOrders_Measurements] FOREIGN KEY ([MeasurementId]) REFERENCES [dbo].[Measurements] ([MeasurementId]);
...
INSERT INTO [dbo].[Employees] ([EmployeeId], [EmployeeName], [RoleType]) VALUES (1, N'Carrie', N'manager')
INSERT INTO [dbo].[Employees] ([EmployeeId], [EmployeeName], [RoleType]) VALUES (2, N'Jing', N'Tailor')
INSERT INTO [dbo].[Employees] ([EmployeeId], [EmployeeName], [RoleType]) VALUES (3, N'Elsa', N'reciptionist')
SET IDENTITY_INSERT [dbo].[Emplyees] OFF
GO
