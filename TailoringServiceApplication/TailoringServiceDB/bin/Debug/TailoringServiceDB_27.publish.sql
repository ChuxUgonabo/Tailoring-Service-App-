...
ALTER TABLE [dbo].[Bills]
    ADD CONSTRAINT [FK_Bills_Order] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]) ON DELETE CASCADE;
...
INSERT INTO [dbo].[Bills] ([BillId], [Amount], [Payment], [Status], [OrderId]) VALUES (2, 50, N'Credit/Debit', 0, 2)
