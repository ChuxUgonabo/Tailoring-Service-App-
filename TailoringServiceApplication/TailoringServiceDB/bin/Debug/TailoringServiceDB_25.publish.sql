...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Bills_Order]...';


GO
ALTER TABLE [dbo].[Bills]
    ADD CONSTRAINT [FK_Bills_Order] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]);
...
ALTER TABLE [dbo].[Measurements]
    ADD CONSTRAINT [FK_Measurements_Order] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]);
...
INSERT INTO [dbo].[Bills] ([BillId], [Amount], [Payment], [Status], [Status]) VALUES (1, 20, N'cash', 0)

SET IDENTITY_INSERT [dbo].[Bills] OFF
GO

SET IDENTITY_INSERT [dbo].[Measurements] ON
INSERT INTO [dbo].[Measurements] ([MeasurementId], [Gender], [Bust], [Neck], [Waist], [Hip], [Shoulder], [Arm], [Leg], [OrderId]) VALUES (1, 'female',  18.5, 18.5, 18.5, 18.5, 18.5, 18.5, 18.5, 18.5)
