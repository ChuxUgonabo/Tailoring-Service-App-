...
ALTER TABLE [dbo].[Bills]
    ADD CONSTRAINT [FK_Bills_Orders] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Measurements_Orders]...';


GO
ALTER TABLE [dbo].[Measurements]
    ADD CONSTRAINT [FK_Measurements_Orders] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]);
