...
CREATE TABLE [dbo].[TailorOrders] (
    ...
    CONSTRAINT [PK_TailorOrders] PRIMARY KEY CLUSTERED ([TailorId] ASC, [OrderId] ASC)
);
...
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Measurements] FOREIGN KEY ([MeasurementId]) REFERENCES [dbo].[Measurements] ([MeasurementId]);
