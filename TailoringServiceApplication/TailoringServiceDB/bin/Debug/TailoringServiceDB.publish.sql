...
GO
PRINT N'Creating Table [dbo].[OrderMeasurements]...';
...
CREATE TABLE [dbo].[TailorOrders] (
    ...
    [Staus]      NCHAR (10) NOT NULL,
    PRIMARY KEY CLUSTERED ([TailorId] ASC)
);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Orders_Measurements]...';


GO
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Measurements] FOREIGN KEY ([MeasurementId]) REFERENCES [dbo].[OrderMeasurements] ([MeasurementId]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Orders_Bills]...';


GO
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Bills] FOREIGN KEY ([BillId]) REFERENCES [dbo].[Bills] ([BillId]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_TailorOrders_Employees]...';


GO
ALTER TABLE [dbo].[TailorOrders]
    ADD CONSTRAINT [FK_TailorOrders_Employees] FOREIGN KEY ([EmployeeId]) REFERENCES [dbo].[Employees] ([EmployeeId]);
...
GO
ALTER TABLE [dbo].[TailorOrders]
    ADD CONSTRAINT [FK_TailorOrders_Orders] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Orders] ([OrderId]);
