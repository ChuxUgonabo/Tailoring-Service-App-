...
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Employees] FOREIGN KEY ([EmployeeId]) REFERENCES [dbo].[Employees] ([EmployeeId]) ON UPDATE CASCADE;
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '5ec812db-254e-4b89-a79d-36b6d2c513f3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('5ec812db-254e-4b89-a79d-36b6d2c513f3')
